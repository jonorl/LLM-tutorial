...
max_iters = 1200  # reduced - stop before overfitting
eval_interval = 100  # more frequent evaluation
learning_rate = 3e-4
device = 'cuda' if torch.cuda.is_available() else 'cpu'
eval_iters = 200
n_embd = 256  # reduced model size
n_head = 4  # reduced heads
n_layer = 4  # reduced layers
dropout = 0.45  # increased dropout for regularization
warmup_iters = 100
grad_accum_steps = 8  # increased to maintain effective batch size of 128
